  ...
  return (
    <div>
      ...
      <div>
        ...
        <InputField handleChange={handleChange} value="durban" title="Durban" name="test" />
        <InputField handleChange={handleChange} value="london" title="London" name="test" />
        <InputField handleChange={handleChange} value="johannesburg" title="Johannesburg" name="test" />
