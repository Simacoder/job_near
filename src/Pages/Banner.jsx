...
const Banner = ({query, handleInputChange}) => {
  ...
  return (
    <div className="max-w-screen-2xl container mx-auto xl:px-24 px-4 md:py-20 py-14">
        <h1 className="text-5xl font-bold text-primary mb-3">Find your <span className="text-blue">
        job near</span> home</h1>
        <p className='text-lg text-black/70 mb-8'>
            Thousands of Job at your backyard are click away, any job.</p>
        <form>
            <div className='flex justify-start md:flex-row flex-col md:gap-0 gap-4'>
                ...
                <input type='text' name='title' id='title' placeholder='What job are you looking for?'  className='block flex-1 border-0 bg-transparent
